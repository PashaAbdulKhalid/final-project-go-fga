...
type SocialMediaUsecaseImpl struct {
	socialMediaRepo socmed.SocialMediaRepo
}

func NewSocialMediaUsecase(socialMediaRepo socmed.SocialMediaRepo) socmed.SocialMediaUsecase {
	return &SocialMediaUsecaseImpl{socialMediaRepo: socialMediaRepo}
}

func (s *SocialMediaUsecaseImpl) CreateSocialMediaSvc(ctx context.Context, socialMedia socmed.SocialMedia) (result socmed.SocialMedia, errMsg message.ErrorMessage) {
...
func (s *SocialMediaUsecaseImpl) GetSocialMediasSvc(ctx context.Context) (result []socmed.SocialMedia, errMsg message.ErrorMessage) {
...
func (s *SocialMediaUsecaseImpl) GetSocialMediaByIdSvc(ctx context.Context, socmedId uint64) (result socmed.SocialMedia, errMsg message.ErrorMessage) {
...
func (s *SocialMediaUsecaseImpl) UpdateSocialMediaSvc(ctx context.Context, inputSocialMedia socmed.SocialMedia) (result socmed.SocialMedia, errMsg message.ErrorMessage) {
